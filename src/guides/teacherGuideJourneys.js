...
export const TEACHER_GUIDE_JOURNEYS = Object.freeze([
    ...
    },
    {
        ...
        steps: [
            ...
            step('neighbor-agit', '이웃 학급과 글 나누기', '공간을 연결하고 교사 상호 승인 뒤 글 나눔·함께 쓰는 주제·글짝 교환 활동과 학생 글 검토를 관리합니다.', 'neighbor-agit')
        ]
    },
    {
        id: 'motivation',
    ...
    },
    {
        ...
        estimatedTime: '학기말',
        steps: [
            step('class-exhibition', '우리 반 글 전시관', '작품을 선정하고 공간을 꾸며 학생 감상·외부 공유로 이어갑니다.', 'class-agit'),
