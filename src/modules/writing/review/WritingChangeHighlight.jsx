 ...
 */
const WritingChangeHighlight = ({ before, after, variant = 'merged', enabled = true, showLegend = true, emptyText = '' }) => {
    const diff = useMemo(
        () => (enabled ? diffWritingText(before, after) : null),
