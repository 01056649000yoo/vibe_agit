// 달린 거리에 넣을 수 있는 한 권의 최대 쪽수. SQL 의 `reading_marathon_max_pages_v1()` 와 같은 값이어야 한다.
// 전집·세트를 한 권으로 올리면 4,040쪽이 곧바로 4km 로 잡히던 문제(2026-09-07)를 막는다.
export const MARATHON_MAX_PAGES = 1000;
