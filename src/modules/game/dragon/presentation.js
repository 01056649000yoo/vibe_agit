...
export const HIDEOUT_BACKGROUNDS = {
    ...
    'wave-harbor': { id: 'wave-harbor', name: '푸른 파도 항구 프레임', color: 'linear-gradient(135deg,#e8fbff,#8bd8e4)', border: '#49aebf', textColor: '#174f5b', subColor: '#318797', price: 1000, requiredWriterLevel: 1, theme: 'wave-harbor', glow: 'rgba(69,190,205,.42)', readerTone: 'vivid' },
    'dreamlight-library': { id: 'dreamlight-library', name: '꿈빛 서재 프레임', color: 'linear-gradient(135deg,#f7eaff,#bca8e7)', border: '#9d7fc9', textColor: '#4e3e70', subColor: '#8067ad', price: 1200, requiredWriterLevel: 1, theme: 'dreamlight-library', glow: 'rgba(185,145,233,.46)', readerTone: 'dark' },
    sky: { id: 'sky', name: '☁️ 구름 프레임', color: 'linear-gradient(180deg, #0288D1 0%, #E1F5FE 70%, #FFFFFF 100%)', border: '#81D4FA', textColor: '#01579B', subColor: '#0288D1', rarity: 'starter', theme: 'sky', glow: 'rgba(129, 212, 250, 0.4)', readerTone: 'vivid' },
    forest: { id: 'forest', name: '🌿 고목 숲 프레임', color: 'linear-gradient(135deg, #244a2d 0%, #7ba05b 100%)', border: '#6f8f4e', textColor: '#f4ffe8', subColor: '#c8e6a0', rarity: 'common', theme: 'forest', glow: 'rgba(112, 159, 80, 0.42)', readerTone: 'vivid' },
    volcano: { id: 'volcano', name: '🌋 용암 프레임', color: 'linear-gradient(135deg, #4A0000 0%, #8B0000 100%)', border: '#FF5722', textColor: 'white', subColor: '#FFCCBC', rarity: 'common', theme: 'ember', glow: 'rgba(255, 87, 34, 0.4)', readerTone: 'dark' },
    moon: { id: 'moon', name: '🌙 달빛 프레임', color: 'linear-gradient(135deg, #17284d 0%, #7776b8 100%)', border: '#b9c9ff', textColor: '#f8f6ff', subColor: '#d8dcff', rarity: 'rare', theme: 'moon', glow: 'rgba(174, 192, 255, 0.48)', readerTone: 'dark' },
    crystal: { id: 'crystal', name: '💎 수정 프레임', color: 'linear-gradient(135deg, #4A148C 0%, #7B1FA2 100%)', border: '#BA68C8', textColor: 'white', subColor: '#E1BEE7', rarity: 'rare', theme: 'crystal', glow: 'rgba(186, 104, 200, 0.4)', readerTone: 'dark' },
    rune: { id: 'rune', name: '🔹 고대 룬 프레임', color: 'linear-gradient(135deg, #1d272b 0%, #304f55 100%)', border: '#54d9dc', textColor: '#e8ffff', subColor: '#92f0e6', rarity: 'hero', theme: 'rune', glow: 'rgba(67, 220, 218, 0.48)', readerTone: 'dark' },
    storm: { id: 'storm', name: '🌩️ 번개 프레임', color: 'linear-gradient(180deg, #050A30 0%, #000C66 50%, #000000 100%)', border: '#7986CB', textColor: 'white', subColor: '#C5CAE9', rarity: 'hero', theme: 'storm', glow: 'rgba(121, 134, 203, 0.6)', readerTone: 'dark' },
