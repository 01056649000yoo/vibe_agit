...
import { classroomArrangementManifest } from './manifest.js';
...
export default function ClassroomArrangementTeacherEntry({ activeClass, previewWorkspace = null }) {
  ...
  return <section className="classroom-arrangement">
    <header className="arrange-header">
      <div><TeacherPageTitle title={classroomArrangementManifest.name} guideTabId="classroom-arrangement" /><p>자리 배치와 역할 나누기를 현재 아지트 학급 명부로 사용합니다.</p></div>
    ...
    <div>
      ...
      {tab === 'settings' ? <>
        ...
        <div className="arrange-settings-utilities">
