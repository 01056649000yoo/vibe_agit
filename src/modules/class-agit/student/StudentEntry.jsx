    ...
    return <main className="class-agit class-agit-student" ref={root}>
        ...
        {mode === 'list' ? <>
            ...
            <section className="class-agit-student-shelf" aria-labelledby="class-agit-gallery-heading">
                <h2 id="class-agit-gallery-heading">🖼 글꽃 전시관</h2>
            ...
            {mode === 'lobby' ? <div className="class-agit-lobby">
                <div className="class-agit-lobby__copy"><span className="class-agit-eyebrow">우리반 아지트 · 글꽃 전시관</span><h1 tabIndex={-1}>{roomData.title}</h1><p>{roomData.introduction}</p>
