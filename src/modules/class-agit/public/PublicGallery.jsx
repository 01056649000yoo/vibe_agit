...
export default function PublicGallery({ token, api = publicClassAgitApi, isPreview = false, onExit }) {
    ...
    return <main ref={root} className="class-agit class-agit-public">
        ...
        {page.error && <p className="class-agit-error" role="alert">{page.error}</p>}{page.loading && <p role="status">전시를 불러오고 있습니다…</p>}
        ...
        {workId && <ArtworkReader work={detail.data?.work} loading={detail.loading} error={detail.error} onClose={close} />}
