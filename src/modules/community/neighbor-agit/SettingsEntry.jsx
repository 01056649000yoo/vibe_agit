const NeighborAgitSettingsEntry = ({ activeClass, isMobile }) => (
    <section style={{
        ...
        <div style={{ maxWidth: '560px' }}>
            ...
            <span style={{ display: 'inline-block', marginTop: '18px', padding: '7px 11px', borderRadius: '10px', background: '#CCFBF1', color: '#0F766E', fontSize: 'var(--ui-text-sm)', fontWeight: 900 }}>
                운영 기능 준비 중
            </span>
        </div>
    </section>
