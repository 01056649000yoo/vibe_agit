 ...
 *  2026-09-24: 마을 장소 이름으로 바꿨다 — 🌳 이웃 글 마당 · 🎪 같이 쓰기 광장 · 🏛️ 문집 도서관
 *  (옛 이름은 WORKLOG 2026-09-24. tests/neighborSpaceNames.test.mjs 가 옛 이름이 다시 들어오는 것을 막는다).
 *  2026-09-06에 글짝 교환 활동을 제품에서 뺐다(SQL 61254).
 *  2026-09-23에 🏛️ 문집 도서관을 더했다(SQL 20261335) — 글 한 편이 아니라 확정한 학급 문집을 소개하고 방문록을 받는다.
