 ...
 */
/*
 * `icon` 은 `variant='help'` 일 때 글자 앞에 붙는 그림이다. 기본은 💡(탭 도움말).
 * 활용 안내서처럼 **찾아보는 성격**인 자리는 돋보기를 넘겨 쓴다.
 */
const GuideInfoButton = ({ label, title = label, className = '', onClick, variant = 'icon', size = 'md', text = '도움말', icon = '💡' }) => (
    <button
        type="button"
