        ...
        <div style={{ textAlign: 'left' }}>
            ...
            <section style={{ marginBottom: '20px' }}>
                ...
                <ul style={{ paddingLeft: '20px', marginTop: '5px' }}>
                    ...
                    <li>그 기간 동안 교사는 학급의 글을 <strong>선생님 본인의 구글 계정에 구글 문서로 저장</strong>할 수 있습니다. 이 문서는 선생님의 구글 드라이브에 만들어지고 소유자도 선생님이므로, <strong>서비스가 종료된 뒤에도 그대로 남습니다.</strong> 과제는 '보관함'에서, 일기와 독서록은 각 관리 화면에서 내보낼 수 있으며, 같은 자리에서 엑셀·PDF 파일로 내려받을 수도 있습니다.</li>
                    <li>가능한 한 <strong>학기 중 종료를 피하고 학년말에 맞추도록</strong> 노력합니다.</li>
                    <li>종료일 이후 운영자 서버에 남은 학생·교사의 개인정보와 작성물은 개인정보처리방침에 따라 파기하며, 파기한 자료는 복구할 수 없습니다. <strong>미리 내보내 두신 구글 문서와 파일은 영향을 받지 않습니다.</strong></li>
                </ul>
                ...
                <p style={{ marginTop: '10px' }}><strong>(5) 사전 통지가 어려운 경우</strong> — 천재지변 등 운영자가 통제할 수 없는 사유로 사전 통지가 불가능한 경우에는 통지가 늦어지거나 생략될 수 있습니다. 이 경우에도 가능해지는 즉시 알리고 내보내기 기간을 두도록 노력합니다.</p>
            </section>
