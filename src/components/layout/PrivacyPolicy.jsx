    ...
    return (
        <div style={{ textAlign: 'left', lineHeight: '1.6', color: '#444' }}>
            ...
            <section style={{ marginBottom: '30px' }}>
                ...
                <p style={{ marginTop: '10px' }}><strong>서비스 전체가 종료되는 경우</strong> — 이용약관 제7조에 따라 최소 30일의 사전 공지와 내보내기 기간을 둔 뒤, 종료일로부터 30일 이내에 보관 중인 모든 개인정보와 작성물을 서버에서 파기합니다. 원격에 보관하는 암호화 백업본은 30일이 지나면 자동 삭제되므로, <strong>종료일로부터 최대 60일 안에 모든 사본이 사라집니다.</strong></p>
