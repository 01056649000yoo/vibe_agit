...
export const landingExperiences = [
  {
    ...
    icon: '✍️',
    tone: 'writing',
    title: '선생님과 함께 배우고 다양하게 쓰기',
    shortLead: '배우고 생각하며',
    shortNoun: '다양하게 쓰기',
    summary: '선생님은 과제와 연구소 활동, 질문·피드백으로 글쓰기를 지도하고, 학생은 여러 글 형식과 생각 도구를 오가며 자기 글을 완성해요.',
    details: [
      { title: '글쓰기 과정을 설계하고 지도하기', description: '선생님은 과제와 연구소 활동을 준비하고 핵심 질문·안내를 건넨 뒤, 학생 글을 확인·보완 요청·평가하며 성장을 지도해요.' },
      { title: '여러 방법으로 생각하고 쓰기', description: '학생은 자유 글·일기·독서록부터 시·보고서까지 알맞은 형식으로 쓰고, 맞춤법 도구와 친구의 댓글·반응으로 다듬어요.' },
      { title: '글쓰기 연구소에서 생각 키우기', description: '글 개요짜기·질문 만들기·좋은 질문 고르기·한줄모아·한자 활용 문장으로 생각을 만들고, 결과를 글쓰기 참고함에서 불러와 이어 써요.' },
    ],
  },
  {
    id: 'reading',
