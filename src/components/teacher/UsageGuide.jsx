            ...
            <section id="vocab-tower" style={sectionStyle}>
                ...
                <div style={cardStyle}>
                    ...
                    <p><strong>1. 게임 방식</strong><br />
                        학생들은 80초~120초의 제한 시간 동안 학년별 단어 퀴즈를 풀며 최대한 높은 층으로 올라가야 합니다. 오답을 선택해도 층수는 깎이지 않으니 포기하지 말고 끝까지 도전하세요! <strong>높은 층에 올라갈수록 보너스 시간</strong>이 주어져 더 오래 게임을 즐길 수 있습니다. ⏱️</p>
                </div>
                <div style={cardStyle}>
