...
export async function createClassAgitReleaseFixture() {
    ...
    const api = {
        ...
        async getBookPreview(_class, id, revision) {
            ...
            return { version: 1, id, number: 0, draft: true, book: { title: book.title, subtitle: book.subtitle, cover_kicker: book.cover_kicker, introduction: book.introduction, class_label: book.class_label, term: book.term, issue_date: book.issue_date, grouping: book.grouping, print: createBookPrintSettings(book), works } };
        },
