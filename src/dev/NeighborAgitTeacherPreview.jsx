...
const workspace = {
  ...
  memberships: [
    { class_id: classOne, class_name: '햇살반', role: 'host', status: 'active', student_access_enabled: true },
    { class_id: classTwo, class_name: '바다반', role: 'guest', status: 'active', student_access_enabled: true },
  ],
  activities: [{
    id: activityId,
    type: 'exchange',
...
const previewApi = {
  ...
  async runAction(_classId, action) {
    return {
  ...
  async getPostDetail() {
    return { version: 1, shared_post_id: 'review-1', title: '우리 동네 작은 숲', content: '미리보기 글 내용', comments: [] }
  },
}
