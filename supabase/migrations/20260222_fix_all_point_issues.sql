-- ====================================================================
-- 🛡️ [포인트 시스템 긴급 수정] 보안 트리거 우회 및 RPC 호환성 패치
-- 작성일: 2026-02-22
--
-- 문제: 
--   1. students 테이블의 보호 트리거가 RPC를 통한 정상적인 업데이트도 차단함
--   2. spend_student_points 및 increment_student_points RPC의 매개변수 불일치
--
-- 해결:
--   1. 보호 트리거에 세션 변수(app.bypass_student_trigger)를 통한 우회 로직 추가
--   2. 포인트 관련 RPC들에 우회 설정 추가 및 매개변수 명칭 통일
-- ====================================================================
...
-- 2. spend_student_points RPC 재정의 (우회 로직 및 public 접두사 강화)
...
-- 3. increment_student_points RPC 재정의 (우회 로직 추가 및 매개변수 명확화)
