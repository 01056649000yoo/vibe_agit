...
1. **`학급 미개설` / `학생 미등록` 중에 고릅니다.**
   - `학급 미개설`만 **영구 삭제** 버튼이 나옵니다. 지울 데이터가 없는 계정이기 때문입니다.
   - `학생 미등록`은 학급 자료가 남아 있어 **승인 취소만** 가능합니다.
...
> **서버에서 한 번 더 막습니다.** 삭제 요청이 가더라도, 학급이나 학생이 하나라도 있는 계정은
